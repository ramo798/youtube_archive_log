...
def get_initial_continuation(target_url, session):
    ...
    continue_dict = {}
    continuations = ytInitialData['contents']['twoColumnWatchNextResults']['conversationBar']['liveChatRenderer'][
    ...
    if not continue_url:
        continue_url = ytInitialData["contents"]["twoColumnWatchNextResults"]["conversationBar"]["liveChatRenderer"]["continuations"][0].get(
...
if __name__ == '__main__':
    get_chat_replay_data('wh0qATKFpOo')
